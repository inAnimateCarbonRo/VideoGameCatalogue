...
namespace VideoGameCatalogue.Api_Deprecated.Controllers
{
    ...
    public class VideoGamesController : ControllerBase
    {
        ...
        [HttpGet(Api_DeprecatedEndpoints.VideoGameEndpoints.GetAll)]
        ...
        [HttpGet(Api_DeprecatedEndpoints.VideoGameEndpoints.Get)]
        ...
        [HttpGet(Api_DeprecatedEndpoints.VideoGameEndpoints.GetAllIncludingDeleted)]
        [ProducesResponseType(typeof(VideoGamesResponse), StatusCodes.Status200OK)]
        ...
        [HttpPost(Api_DeprecatedEndpoints.VideoGameEndpoints.Create)]
        ...
        [HttpPut(Api_DeprecatedEndpoints.VideoGameEndpoints.Update)]
        [ProducesResponseType(typeof(VideoGameResponse), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status409Conflict)]
        ...
        [HttpDelete(Api_DeprecatedEndpoints.VideoGameEndpoints.Delete)]
        ...
        [HttpPut(Api_DeprecatedEndpoints.VideoGameEndpoints.Restore)]
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        ...
        [HttpDelete(Api_DeprecatedEndpoints.VideoGameEndpoints.FullDelete)]
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
