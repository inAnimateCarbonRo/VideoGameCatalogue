...
namespace VideoGameCatalogue.Api_Deprecated.Controllers
{
    ...
    public class GenresController : ControllerBase
    {
        ...
        [HttpGet(Api_DeprecatedEndpoints.GenreEndpoints.GetAll)]
        ...
        [HttpGet(Api_DeprecatedEndpoints.GenreEndpoints.Get)]
        ...
        [HttpGet(Api_DeprecatedEndpoints.GenreEndpoints.GetAllIncludingDeleted)]
        [ProducesResponseType(typeof(GenresResponse), StatusCodes.Status200OK)]
        ...
        [HttpPost(Api_DeprecatedEndpoints.GenreEndpoints.Create)]
        ...
        [HttpPut(Api_DeprecatedEndpoints.GenreEndpoints.Update)]
        ...
        [HttpDelete(Api_DeprecatedEndpoints.GenreEndpoints.Delete)]
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        ...
        [HttpPut(Api_DeprecatedEndpoints.GenreEndpoints.Restore)]
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        ...
        [HttpDelete(Api_DeprecatedEndpoints.GenreEndpoints.FullDelete)]
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
